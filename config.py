...
REDDIT_TTL_SECONDS = int(os.getenv("REDDIT_TTL_SECONDS", 86400))  # 24 hours
HACKERNEWS_TTL_SECONDS = int(os.getenv("HACKERNEWS_TTL_SECONDS", 604800))  # 7 days
YOUTUBE_TRENDING_TTL_SECONDS = int(os.getenv("YOUTUBE_TRENDING_TTL_SECONDS", 86400))  # 24 hours
YOUTUBE_COMMENTS_TTL_SECONDS = int(os.getenv("YOUTUBE_COMMENTS_TTL_SECONDS", 604800))  # 7 days
